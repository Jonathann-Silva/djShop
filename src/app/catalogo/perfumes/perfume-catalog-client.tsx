...
export function PerfumeCatalogClient({ products, availableBrands: allBrands }: PerfumeCatalogClientProps) {
  const [loading, setLoading] = useState(false); // Initially false as data is passed as props
  ...
  const { filteredAndSortedProducts, availableBrandsForGender } = useMemo(() => {
    ...
    return {
      ...
      availableBrandsForGender: currentBrands,
    };
